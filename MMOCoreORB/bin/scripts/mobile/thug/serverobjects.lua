...
includeFile("thug/dark_force_knight.lua")
includeFile("thug/dark_force_master.lua")
...
includeFile("thug/imperial_inquisitor_boss.lua")
includeFile("thug/industrial_spy.lua")
includeFile("thug/information_broker.lua")
includeFile("thug/jk_hunt_bh.lua")
