krayt_dragon_ancient_event = Creature:new {
	objectName = "@mob/creature_names:ancient_krayt_dragon_event",
	customName = "Ancient Krayt Dragon Leader",
	socialGroup = "krayt",
	faction = "",
...
CreatureTemplates:addCreatureTemplate(krayt_dragon_ancient_event, "krayt_dragon_ancient_event")