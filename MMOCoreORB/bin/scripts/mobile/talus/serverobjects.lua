...
includeFile("talus/defector_rebel_commando.lua")
includeFile("talus/defector_rebel_trooper.lua")
includeFile("talus/defector_storm_commando.lua")
includeFile("talus/defector_stormtrooper.lua")
...
includeFile("talus/gcw_cave_imperial_officer.lua")
includeFile("talus/gcw_cave_rebel_officer.lua")
