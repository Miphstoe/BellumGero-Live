black_sun_assassin_krayt_ancient = Creature:new {
	objectName = "",
	customName = "Black Sun Assassin (Ancient)",
	mobType = MOB_NPC,
...
CreatureTemplates:addCreatureTemplate(black_sun_assassin_krayt_ancient, "black_sun_assassin_krayt_ancient")
