black_sun_assassin_krayt_grand = Creature:new {
	objectName = "",
	customName = "Black Sun Assassin (Grand)",
	mobType = MOB_NPC,
...
CreatureTemplates:addCreatureTemplate(black_sun_assassin_krayt_grand, "black_sun_assassin_krayt_grand")
