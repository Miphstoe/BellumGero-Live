ambush_rebel_commando = Creature:new {
	objectName = "@mob/creature_names:ambush_rebel_commando",
...
CreatureTemplates:addCreatureTemplate(ambush_rebel_commando, "ambush_rebel_commando")