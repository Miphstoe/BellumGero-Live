tatooine_monstrous_rock_beetle_click_neutral_medium = Lair:new {
	mobiles = {{"monstrous_rockmite",1}, {"monstrous_sand_beetle",1}},
	spawnLimit = 15,
...
addLairTemplate("tatooine_monstrous_rock_beetle_click_neutral_medium", tatooine_monstrous_rock_beetle_click_neutral_medium)
