...
--				{"Random lvl 20 Hvy Weapons (flame/acid/LLC) - 15k", "option63"}, 
        {"DL44 Pistol (90 damage, 3.4 speed) - 25k", "option3"},
        {"DH17 Snubnose Carbine (115 damage, 3.5 speed) - 25k", "option1"},
        {"DLT20a Rifle	(360 damage, 6.0 speed) - 25k", "option2"},
        {"Vibro Knuckler (130 damage, 2.3 speed) - 25k", "option7"},
        {"1h curved Sword (182 damage, 3.1 speed) - 25k", "option4"},
        {"2h Battle Axe (357 damage, 4.5 speed) - 25k", "option5"},
        {"Reinforced Combat Staff (364 damage, 4.7 speed) - 25k", "option6"},
