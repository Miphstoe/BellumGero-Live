...
--				{"Random lvl 20 Hvy Weapons (flame/acid/LLC) - 15k", "option63"}, 
        ...
        {"DLT20a Rifle	(130 damage, 6.0 speed) - 25k", "option2"},
        {"Vibro Knuckler (130 damage, 2.3 speed) - 25k", "option7"},
        {"1h curved Sword (100 damage, 3.1 speed) - 25k", "option4"},
        {"2h Battle Axe (125 damage, 4.5 speed) - 25k", "option5"},
        {"Reinforced Combat Staff (80 damage, 4.7 speed) - 25k", "option6"},
