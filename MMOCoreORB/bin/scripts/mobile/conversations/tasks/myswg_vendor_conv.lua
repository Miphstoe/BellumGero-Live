...
--				{"Random lvl 20 Hvy Weapons (flame/acid/LLC) - 15k", "option63"}, 
        {"DL44 Pistol (130damage, 3.2speed) - 25k", "option3"},
        {"DH17 Snubnose Carbine (143damage, 4.1speed) - 25k", "option1"},
        {"DLT20a Rifle	(360damage, 6.5speed) - 25k", "option2"},
        {"Vibro Knuckler (111damage, 2.5speed) - 25k", "option7"},
        {"1h curved Sword (182damage, 4.0speed) - 25k", "option4"},
        {"2h Battle Axe (357damage, 4.8speed) - 25k", "option5"},
        {"Reinforced Combat Staff (364damage, 4.5speed) - 25k", "option6"},
