...
tatooine_regions = {
	...
	{"@tatooine_region_names:krayt_graveyard", 7451, 4510, {CIRCLE, 500}, NOSPAWNAREA + NAMEDREGION + NOBUILDZONEAREA + NAVAREA},
	{"@tatooine_region_names:krayt_graveyard_1", 6560, 4096, {RECTANGLE, 7488, 4608}, NOSPAWNAREA + NAMEDREGION + NOBUILDZONEAREA + NAVAREA},
