...
-- BH 34% + DW armor 40% + jetpack 10% + decor 6% + furniture schematics 10%
-- Total = 10,000,000
...
mando_daily_bounty_tier3_loot = {
	...
	maximumLevel = 0,
	lootItems = {
		-- BH armor schematics (34% of pool)
		{itemTemplate = "bounty_hunter_belt_schematic",        weight = 340000},
		{itemTemplate = "bounty_hunter_bicep_l_schematic",     weight = 340000},
		{itemTemplate = "bounty_hunter_bicep_r_schematic",     weight = 340000},
		{itemTemplate = "bounty_hunter_boots_schematic",       weight = 340000},
		{itemTemplate = "bounty_hunter_bracer_l_schematic",    weight = 340000},
		{itemTemplate = "bounty_hunter_bracer_r_schematic",    weight = 340000},
		{itemTemplate = "bounty_hunter_chest_plate_schematic", weight = 340000},
		{itemTemplate = "bounty_hunter_gloves_schematic",      weight = 340000},
		{itemTemplate = "bounty_hunter_helmet_schematic",      weight = 340000},
		{itemTemplate = "bounty_hunter_leggings_schematic",    weight = 340000},
