...
TieredScheduledEvent.START_TIME = { year = 2025, month = 12, day = 21, hour = 19, min = 00, sec = 0 }
TieredScheduledEvent.END_TIME   = { year = 2025, month = 12, day = 21, hour = 20, min = 00, sec = 0 }
...
TieredScheduledEvent.TIER1_NPCS = {
 -- { planet = "corellia", template = "meatlump_fool", x = -172, y = -4723, z = 28, heading = 0 },
  { planet = "corellia", template = "stormtrooper_medium_armor", x = -165, y = -4720, z = 28, heading = 0 },
...
TieredScheduledEvent.TIER2_NPCS = {
  ...
  { planet = "corellia", template = "stormtrooper_captain_medium_armor", x = -165, y = -4720, z = 28, heading = 0 },
...
TieredScheduledEvent.TIER3_NPCS = {
 -- { planet = "corellia", template = "meatlump_loon", x = -172, y = -4723, z = 28, heading = 0 },
  { planet = "corellia", template = "stormtrooper_general_medium_armor", x = -165, y = -4720, z = 28, heading = 0 },
...
TieredScheduledEvent.TIER4_NPCS = {
 -- { planet = "corellia", template = "wookiee_jedi_event", x = -172, y = -4723, z = 28, heading = 0 },
  { planet = "corellia", template = "stormtrooper_surface_marshal_medium_armor", x = -165, y = -4720, z = 28, heading = 0 },
