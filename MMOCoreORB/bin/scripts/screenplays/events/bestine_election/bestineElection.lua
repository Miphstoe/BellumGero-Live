BestineElection = ScreenPlay:new {
	...
	electionDuration = 3 * 24 * 60 * 60 * 1000, -- Duration of the election phase
	timeTilNextElection = 3 * 24 * 60 * 60 * 1000, -- Time until next election, starts immediately after an election ends
