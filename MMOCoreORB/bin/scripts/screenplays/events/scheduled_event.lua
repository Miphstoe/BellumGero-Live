...
ScheduledEvent.START_TIME = { year = 2025, month = 10, day = 26, hour = 18, min = 00, sec = 0 }
ScheduledEvent.END_TIME   = { year = 2025, month = 10, day = 26, hour = 19, min = 00, sec = 0 }
...
-- NPCs
ScheduledEvent.NPCS = {
  { planet = "corellia", template = "krayt_dragon_ancient_event", x = -172, y = -4723, heading = 0 },
