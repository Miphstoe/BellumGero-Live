...
function myswg_vendor:start()     
    ...
    local pWeaponsmith4 = spawnMobile("dantooine", "myswg_vendor", 1, -374, 0, -3021, 35, 0 )--pcity
...
--ARCHITECT
                elseif (optionLink == "option34" and credits < 200000) then
                    -- Bail if the player doesn’t have enough cash on hand.  
                    -- Plays a chat box message from the NPC as well as a system message.
                      nextConversationScreen = conversation:getScreen("insufficient_funds")
                      creature:sendSystemMessage("You have insufficient funds") 
...
--LOOT
                ...
                elseif (optionLink == "option46" and credits < 500000) then
                    -- Bail if the player doesn’t have enough cash on hand.  
                    -- Plays a chat box message from the NPC as well as a system message.
                      nextConversationScreen = conversation:getScreen("insufficient_funds")
                      creature:sendSystemMessage("You have insufficient funds") 
