...
-- Each phase requires 10,000 PvE points
-- Plus: Trivia questions and special requirements (Phase 3: lightsaber crafting)

PADAWAN_TRIALS_PHASE_POINTS = 10000
PADAWAN_TRIALS_TOTAL_PHASES = 5
PADAWAN_TRIALS_TOTAL_REQUIRED_POINTS = 50000  -- 5 phases × 10,000 points

-- Milestone notifications for player progress
padawanTrialMilestones = {
	{ phase = 1, points = 10000, message = "Phase 1 complete! Hunt and grow stronger." },
	{ phase = 2, points = 20000, message = "Phase 2 complete! You are 40% of the way to Padawan status." },
	{ phase = 3, points = 30000, message = "Phase 3 complete! You are halfway to Padawan status." },
	{ phase = 4, points = 40000, message = "Phase 4 complete! One final phase remains." },
	{ phase = 5, points = 50000, message = "All phases complete! You are ready to claim your Padawan status!" }
}
...
padawanPhaseMessages = {
	[1] = {
		...
		hunting_progress = "Continue your hunt. You need 10,000 points to advance.",
	...
	[2] = {
		...
		trivia_failure = "Your answer was incorrect. Meditate and try again.",
		hunting_progress = "Continue hunting. Gather 10,000 more points.",
	...
	[3] = {
		...
		hunting_progress = "With your lightsaber complete, continue your hunt for 10,000 more points.",
	...
	[4] = {
		...
		trivia_failure = "Your answer was incorrect. Meditate and try again.",
		hunting_progress = "Nearly there. Gather 10,000 more points.",
	...
	[5] = {
		...
		trivia_failure = "Your answer was incorrect. Meditate and try again.",
		hunting_progress = "The final stretch. Gather 10,000 more points and claim your destiny.",
