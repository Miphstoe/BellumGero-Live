...
function WoolamanderTempleScreenPlay:spawnMobiles()
	...
	spawnMobile("yavin4", "woolamander_harrower",600,-83.6,2,22.5,-179,3705359)
	spawnMobile("yavin4", "woolamander_harrower",600,-83.6,2,-12.5,-2,3705359)
	...
	spawnMobile("yavin4", "woolamander_harrower",600,-60.5,2,22,178,3705359)
	spawnMobile("yavin4", "woolamander_harrower",600,-60.5,2,-12,0,3705359)
	...
	spawnMobile("yavin4", "woolamander_harrower",600,76.2,2,-9,0,3705362)
	spawnMobile("yavin4", "woolamander_harrower",600,76.2,2,17.3,179,3705362)
