...
function VillageSui:mainCallback(pPlayer, pSui, eventIndex, args)
...
function VillageSui.getOSTime(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function VillageSui.changePhase(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function VillageSui:changePhaseCallback(pPlayer, pSui, eventIndex, args)
	local cancelPressed = (eventIndex == 1)

	if (cancelPressed) then
		VillageSui:showMainPage(pPlayer)
		return
	end
...
function VillageSui.playerLookupByTarget(pPlayer)
	if (pPlayer == nil) then
		return
	end
	...
	VillageSui.playerInfo(pPlayer, targetID)
end

function VillageSui.playerLookupByName(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function VillageSui:playerLookupByNameCallback(pPlayer, pSui, eventIndex, args)
	local cancelPressed = (eventIndex == 1)
	...
	if (args == nil or args == "") then
		...
		VillageSui.playerLookupByName(pPlayer)
		return
	end
...
function VillageSui.playerLookupByOID(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function VillageSui:playerLookupByOIDCallback(pPlayer, pSui, eventIndex, args)
	local cancelPressed = (eventIndex == 1)
	...
	if (args == nil or args == "") then
		...
		VillageSui.playerLookupByOID(pPlayer)
		return
	end
	...
	VillageSui.playerInfo(pPlayer, tonumber(args))
end

function VillageSui.listOnlineVillagePlayers(pPlayer)
	if (pPlayer == nil) then
		return
	end
	...
	local sui = SuiListBox.new("VillageSui", "mainCallback")
	sui.setTitle("Village GM Panel")
...
function VillageSui.playerInfo(pPlayer, targetID)
...
function VillageSui.manageActiveVillageQuest(pPlayer, targetID)
	local pTarget = getSceneObject(targetID)
...
function VillageSui:manageVillageQuestCallback(pPlayer, pSui, eventIndex, args)
	local cancelPressed = (eventIndex == 1)
