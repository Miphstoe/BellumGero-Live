...
object_building_player_player_guildhall_corellia_style_01 = object_building_player_shared_player_guildhall_corellia_style_01:new {
  lotSize = 5,
  -- storageLimit = 1000, -- ❌ not read by the container system
  containerComponentTemplate = "object/building/container/player_house_container.iff", -- ✅ ensure the right component
