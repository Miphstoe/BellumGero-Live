...
includeFile("weapon/ranged/rifle/rifle_foundling_cdef_beskar.lua")
includeFile("weapon/ranged/rifle/rifle_foundling_light_lightning_cannon.lua")
...
includeFile("weapon/ranged/rifle/rifle_mando_way_lightning.lua")
