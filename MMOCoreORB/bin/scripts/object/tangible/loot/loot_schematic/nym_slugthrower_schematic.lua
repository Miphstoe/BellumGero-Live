object_tangible_loot_loot_schematic_nym_slugthrower_schematic = object_tangible_loot_loot_schematic_shared_nym_slugthrower_schematic:new {
	templateType = LOOTSCHEMATIC,
    customName = "Nym's Slugthrower Schematic",
