object_tangible_loot_loot_schematic_mando_way_geo_blaster_schematic = object_tangible_loot_loot_schematic_shared_geonosian_sonic_blaster_schematic:new {
	templateType = LOOTSCHEMATIC,
	customName = "Loot Schematic: Mandalorian Geonosian Blaster Pistol",
