object_draft_schematic_clothing_clothing_armor_501st_clonetrooper_chest_crafted = object_draft_schematic_clothing_shared_clothing_armor_501st_clonetrooper_chest_crafted:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "501st Clone Trooper Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_501st_clonetrooper_chest_crafted, "object/draft_schematic/clothing/clothing_armor_501st_clonetrooper_chest_crafted.iff")