object_draft_schematic_clothing_clothing_armor_marine_chest_plate = object_draft_schematic_clothing_shared_clothing_armor_marine_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marine Armor Chest Plate",
   ...
   targetTemplate = "object/tangible/wearables/armor/marine/armor_marine_chest_plate.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marine_chest_plate, "object/draft_schematic/clothing/clothing_armor_marine_chest_plate.iff")