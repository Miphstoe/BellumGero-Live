object_draft_schematic_clothing_clothing_armor_stormtrooper_leggings = object_draft_schematic_clothing_shared_clothing_armor_stormtrooper_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Stormtrooper Armor Pants",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_stormtrooper_leggings, "object/draft_schematic/clothing/clothing_armor_stormtrooper_leggings.iff")