...
object_creature_player_duros_male = object_creature_player_shared_duros_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_duros_male, "object/creature/player/duros_male.iff")
