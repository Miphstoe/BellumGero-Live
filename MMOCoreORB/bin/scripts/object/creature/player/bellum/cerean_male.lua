...
object_creature_player_cerean_male = object_creature_player_shared_cerean_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_cerean_male, "object/creature/player/cerean_male.iff")
