...
object_creature_player_jenet_male = object_creature_player_shared_jenet_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_jenet_male, "object/creature/player/jenet_male.iff")
