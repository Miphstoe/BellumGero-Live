...
object_creature_player_ewok_male = object_creature_player_shared_ewok_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_ewok_male, "object/creature/player/ewok_male.iff")
