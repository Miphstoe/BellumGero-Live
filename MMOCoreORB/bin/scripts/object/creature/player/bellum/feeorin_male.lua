...
object_creature_player_feeorin_male = object_creature_player_shared_feeorin_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_feeorin_male, "object/creature/player/feeorin_male.iff")
