...
object_creature_player_ewok_female = object_creature_player_shared_ewok_female:new {
...
ObjectTemplates:addTemplate(object_creature_player_ewok_female, "object/creature/player/ewok_female.iff")
