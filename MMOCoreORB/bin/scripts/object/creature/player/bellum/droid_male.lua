...
object_creature_player_droid_male = object_creature_player_shared_droid_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_droid_male, "object/creature/player/droid_male.iff")
