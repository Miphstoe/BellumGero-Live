...
object_creature_player_gungan_male = object_creature_player_shared_gungan_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_gungan_male, "object/creature/player/gungan_male.iff")
