...
object_creature_player_abyssin_male = object_creature_player_shared_abyssin_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_abyssin_male, "object/creature/player/abyssin_male.iff")
