...
This document describes the folder and file layout of the **swg-bg** (SWG Bellum Gero) workspace. It was generated from a full review of the repository. Paths are relative to the workspace root unless noted. *(This file lives at `.cursor/context/WORKSPACE_STRUCTURE.md`.)*
...
|------|------|-------------|
| **.cursor/** | directory | Cursor IDE workspace data: rules, skills, context, extensions, ai-tracking. See [.cursor/README.md](../README.md). |
...
| Item | Type | Description |
|------|------|-------------|
| **context/** | directory | Workspace and AI context docs: **WORKSPACE_STRUCTURE.md** (this file) and any future context docs. Same path on Shadow PC and WSL dev box. See **rules/context-files.mdc**. |
| **ai-tracking/** | directory | AI code-tracking database (`ai-code-tracking.db`). |
| **extensions/** | directory | Installed Cursor/VSCode extensions (e.g. C++, Lua, WSL, SWG IFF/TRE tools). See [.cursor/README.md](../README.md) for SWG tooling. |
...
- **.cursor:** IDE rules, skills, context (this doc), and extensions (see [.cursor/README.md](../README.md)).
...
For Bellum Gero workflow (Shadow PC vs WSL), see the workspace rule **bellum-gero.mdc** and [.cursor/README.md](../README.md).
